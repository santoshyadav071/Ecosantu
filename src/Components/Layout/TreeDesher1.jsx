...
const TreeDesher1 = () => {
  const [mainImage, setMainImage] = useState("/Images/desire1.avif");
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="product-left">
          <div className="product-images">
            ...
            />
            <div className="thumbnail-images flex space-x-2 mt-2">
              {thumbnailImages.map((img, index) => (
                <img
                  ...
                  className="thumbnail w-16 h-16 object-cover rounded cursor-pointer transition-transform transform hover:scale-110"
                />
              ))}
            </div>
          </div>
        ...
        <div className="product-right">
          <div className="product-info space-y-6">
            ...
            <div className="flex items-center gap-3">
              <h1 className="product-title text-2xl md:text-3xl font-bold">Men's Tree Dasher 2</h1>
