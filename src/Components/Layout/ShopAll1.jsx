                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            <img 
                                src="/Images/best.avif" 
                                alt="Wool Runner"
                                className="w-full h-48 object-cover"
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Mens Tree Runner</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Men's Runner Go</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            <img 
                                src="/Images/besttt.avif" 
                                alt="Trail Runner"
                                className="w-full h-48 object-cover"
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Trail Runner</h3>
                                <div className="relative group">
                                    <button className="text-gray-600 text-sm mb-4">Quick Add</button>
                                    <div className="absolute hidden group-hover:block bg-white border border-gray-200 p-2 rounded shadow-lg">
                                        <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            <img 
                                src="/Images/bestttt.avif" 
                                alt="Runner-up Mizzle"
                                className="w-full h-48 object-cover"
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Runner-up Mizzle</h3>
                                <div className="relative group">
                                    <button className="text-gray-600 text-sm mb-4">Quick Add</button>
                                    <div className="absolute hidden group-hover:block bg-white border border-gray-200 p-2 rounded shadow-lg">
                                        <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            <img 
                                src="/Images/bestt.avif" 
                                alt="Runner-up Designer"
                                className="w-full h-48 object-cover"
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Runner-up Designer</h3>
                                <div className="relative group">
                                    <button className="text-gray-600 text-sm mb-4">Quick Add</button>
                                    <div className="absolute hidden group-hover:block bg-white border border-gray-200 p-2 rounded shadow-lg">
                                        <div className="grid grid-cols-2 gap-2">
