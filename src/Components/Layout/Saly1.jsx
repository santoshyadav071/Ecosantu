                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Mens tree flayer</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Mens woolrunner</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Mense Golf Desire</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">Mens tree piper</h3>
                                <div className="relative group">
                                    <button className="text-gray-600 text-sm mb-4">Quick Add</button>
                                    <div className="absolute hidden group-hover:block bg-white border border-gray-200 p-2 rounded shadow-lg">
                                        <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            />
                            <div className="p-4">
                                <h3 className="font-bold text-lg mb-2">mense tree Desire</h3>
                                <div className="relative group">
                                    <button className="text-gray-600 text-sm mb-4">Quick Add</button>
                                    <div className="absolute hidden group-hover:block bg-white border border-gray-200 p-2 rounded shadow-lg">
                                        <div className="grid grid-cols-2 gap-2">
