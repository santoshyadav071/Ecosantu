...
const WoolrunMizz1 = () => {
  const [mainImage, setMainImage] = useState("/Images/runm.avif");
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="product-info space-y-6">
          ...
          <div className="flex items-center gap-3">
            <h1 className="product-title text-2xl md:text-3xl font-bold">Men's Wool Runner Mizzles</h1>
          ...
          <div className="product-description">
            Water-Repellent Wool Sneaker That Keeps Feet Warm And Dry In Unpredictable Weather
          </div>
