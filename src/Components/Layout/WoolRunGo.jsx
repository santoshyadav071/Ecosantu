...
const WoolRunGo = () => {
  const [mainImage, setMainImage] = useState("/Images/Go.avif");
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="product-info space-y-6">
          ...
          <div className="flex items-center gap-3">
            <h1 className="product-title text-3xl font-bold">Men's Wool Runners Go</h1>
          ...
          <div className="product-description">
            Cozy Merino Wool Sneaker With Upgraded Cushioning, Designed For Effortless On-The-Go Comfort
          </div>
