...
const TreeGlider1 = () => {
  const [mainImage, setMainImage] = useState("/Images/glider1.avif");
            ...
            <div className="thumbnail-images flex space-x-2 mt-2 overflow-x-auto">
              {thumbnailImages.map((img, index) => (
                <img
                  ...
                  className="thumbnail w-20 h-20 object-cover cursor-pointer transition-transform transform hover:scale-105"
                />
              ))}
            </div>
          </div>
        ...
        <div className="product-right">
          <div className="product-info space-y-6">
            ...
            <div className="flex items-center gap-3">
              <h1 className="product-title text-2xl md:text-3xl font-bold">Men's Tree Gliders</h1>
            ...
            <div className="size-selector">
              ...
              <div className="size-options grid grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-2">
