...
const Wool1 = () => {
  const [mainImage, setMainImage] = useState("/Images/woolmain.avif");
    ...
    <div className="product-container max-w-7xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="product-images">
          <img 
            src={mainImage}
            alt="Men's Wool Runners - Navy Night"
          ...
          <div className="thumbnail-images flex space-x-2 mt-2 overflow-x-auto">
            {thumbnailImages.map((img, index) => (
              <img
                ...
                className="thumbnail w-16 h-16 object-cover rounded cursor-pointer transition-transform transform hover:scale-105"
              />
            ))}
          </div>
        </div>
        ...
        <div className="product-info space-y-6">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="product-title text-2xl md:text-3xl font-bold">Men's Wool Runners</h1>
          ...
          <div className="product-description">
            The Original Best-Selling Sneaker Combines Soft Merino Wool With Cloud-Like Comfort
          </div>
            ...
            <div className="color-options grid grid-cols-2 sm:grid-cols-4 gap-3">
              {colorOptions.map((option) => (
                ...
                >
                  ...
                  />
                  <span className="mt-2 text-sm text-center">{option.name}</span>
                </button>
              ))}
            </div>
          </div>
